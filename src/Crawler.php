...
class Crawler
{
    ...
    */
     ...
     *
     * @var string $articleSelectorInList
    */
    ...
    */
     ...
     *
     * @var int|null $limitOfPostsToScrape
    */
    ...
    */
                                            ...
                                            SymfonyCrawler $element)
    {
        ...
        if($articleAttribute->getIgnoringNodes()->isNotEmpty()) {
            $articleAttribute->getIgnoringNodes()->each(function (string $node) use (&$attributeValue, $articleAttribute, &$web){
                $attributeValue = $this->removeHtmlTags($web, $attributeValue, $node);
            });
        }

        if($articleAttribute->getReplacingAttributes()->isNotEmpty()) {
            $articleAttribute->getReplacingAttributes()->each(function (array $replacingAttributeArray) use (&$attributeValue, $articleAttribute){
